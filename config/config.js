...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-xyc');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\XYC\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/XYC/';
  if (isLinux) dataDir = process.env.HOME + '/.XYC/';
}
